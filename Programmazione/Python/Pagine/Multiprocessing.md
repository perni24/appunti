...
## 💡 Concetto Chiave
Il **Multiprocessing** è una tecnica che permette di eseguire più processi indipendenti contemporaneamente, ciascuno con la propria istanza dell'interprete Python e il proprio spazio di memoria. A differenza del [[Threading]], il multiprocessing permette di superare i limiti del [[Global Interpreter Lock|GIL]], rendendolo la scelta ideale per operazioni **CPU-bound** (calcoli intensivi).
...
# Funzione da eseguire in un processo separato
