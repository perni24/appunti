...
Usa immutabilita quando vuoi rendere i cambiamenti prevedibili, evitare side effect e confrontare versioni diverse di uno stato.
...
- reducer;
- funzioni pure;
- dati condivisi tra moduli;
- undo/redo;
- caching;
- test di logica di dominio.

Non significa non modificare mai nulla: significa controllare dove e quando avviene la mutazione.
...
Aggiornare un elemento in una lista senza mutare l'array originale:
...
Gli elementi non modificati mantengono lo stesso riferimento; quello aggiornato viene ricreato.
