...
- **`-D` / `--pgdata`**: Specifica la posizione della [[Pagine/File System Layout e Data Directory|Data Directory]].
...
## ⚙️ Logic Layer: Gestione del Servizio (`pg_ctl`)
...
## ⚠️ Best Practices post-installazione
