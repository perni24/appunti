...
```bash
# Esempio backup in formato testuale
pg_dump mio_db > backup.sql

# Esempio backup in formato directory (parallelo e compresso)
...
## ⚙️ Logic Layer: Continuous Archiving e PITR
...
## 🛠️ Tool di Manutenzione Avanzata
