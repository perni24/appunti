...
# Creazione di una tabella in uno schema specifico
...
```sql
# Visualizzare il path corrente
SHOW search_path;

# Impostazione temporanea (sessione)
SET search_path TO vendite, public;

# Impostazione permanente per un utente
ALTER ROLE luca SET search_path TO vendite, public;
```

---

## ⚙️ Logic Layer: Isolamento e Sicurezza
