...
Nota seedling su **AsRef, AsMut e Borrow** in Rust. L'argomento appartiene a **Percorso Intermedio** / **Standard Library** e va sviluppato con definizione, motivazione, esempi e collegamenti alle note vicine.

## Concetto chiave

Descrivi qui il ruolo di **AsRef, AsMut e Borrow** nel linguaggio, nella standard library o nell'ecosistema Rust. Evidenzia soprattutto cosa risolve e quali vincoli introduce rispetto a ownership, type system, performance o sicurezza.
