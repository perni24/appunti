...
Nota seedling su **Generic Associated Types (GAT)** in Rust. L'argomento appartiene a **Percorso Intermedio** / **Astrazione e Generici** e va sviluppato con definizione, motivazione, esempi e collegamenti alle note vicine.

## Concetto chiave

Descrivi qui il ruolo di **Generic Associated Types (GAT)** nel linguaggio, nella standard library o nell'ecosistema Rust. Evidenzia soprattutto cosa risolve e quali vincoli introduce rispetto a ownership, type system, performance o sicurezza.
