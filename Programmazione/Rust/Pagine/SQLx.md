...
Nota seedling su **SQLx** in Rust. L'argomento appartiene a **Applicazioni e Ecosistema** / **Backend, Networking e Database** e va sviluppato con definizione, motivazione, esempi e collegamenti alle note vicine.

## Concetto chiave

Descrivi qui il ruolo di **SQLx** nel linguaggio, nella standard library o nell'ecosistema Rust. Evidenzia soprattutto cosa risolve e quali vincoli introduce rispetto a ownership, type system, performance o sicurezza.
