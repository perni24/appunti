...
Nota seedling su **Cargo.toml** in Rust. L'argomento appartiene a **Percorso Intermedio** / **Cargo, Editions e Compatibilita** e va sviluppato con definizione, motivazione, esempi e collegamenti alle note vicine.

## Concetto chiave

Descrivi qui il ruolo di **Cargo.toml** nel linguaggio, nella standard library o nell'ecosistema Rust. Evidenzia soprattutto cosa risolve e quali vincoli introduce rispetto a ownership, type system, performance o sicurezza.
